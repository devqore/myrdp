...
class Ui_HostConfig(object):
    def setupUi(self, HostConfig):
        ...
        self.address.setStyleSheet(_fromUtf8("background-color: #fffbca;"))
        ...
        self.user.setStyleSheet(_fromUtf8("background-color: #fffbca;"))
        ...
        self.password.setStyleSheet(_fromUtf8("background-color: #fffbca;"))
