...
class MainWindow(QMainWindow):
    ...
    def restoreSettings(self):
        ...
        trayIconVisibility = bool(self.config.getValue('trayIconVisibility', "true"))
        self.tray.setVisible(trayIconVisibility)

        self.showHostsInGroups = bool(self.config.getValue('showHostsInGroups', 'false'))

        if self.tray.isVisible():
            mainWindowVisibility = bool(self.config.getValue('mainWindowVisibility', "true"))
