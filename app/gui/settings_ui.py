...
class Ui_SettingsPage(object):
    def setupUi(self, SettingsPage):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/ico/open.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.freerdp_executable_button.setIcon(icon)
        self.freerdp_executable_button.setObjectName(_fromUtf8("freerdp_executable_button"))
        self.gridLayout.addWidget(self.freerdp_executable_button, 1, 2, 1, 1)
        ...
        self.database_location_button.setIcon(icon)
        ...
        self.gridLayout.addWidget(self.freerdp_executable, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.freerdp_arguments, 2, 1, 1, 2)
        self.logging_level = QtGui.QComboBox(SettingsPage)
        self.logging_level.setObjectName(_fromUtf8("logging_level"))
        self.gridLayout.addWidget(self.logging_level, 3, 1, 1, 2)
